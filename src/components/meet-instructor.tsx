...
export default function MeetTheInstructor() {
  ...
  return (
    ...
    >
      {/* Background glow */}
      <div className='absolute bottom-0 right-1/4 w-[500px] h-[400px] bg-[#2563eb]/4 rounded-full blur-[140px] pointer-events-none' />
      ...
      <div className='max-w-[1100px] mx-auto'>
        ...
        >
          ...
          <div className='relative w-full lg:w-[42%] min-h-[320px] lg:min-h-[540px] flex-shrink-0 bg-[#0d1a2e]'>
            <Image
              src='/femi.jpg'
              alt='Femi Olawale'
              fill
            ...
            <div className='absolute inset-0 bg-gradient-to-t from-[#0b1628]/60 via-transparent to-transparent lg:bg-gradient-to-r lg:from-transparent lg:to-[#0b1628]/80' />
          </div>
          ...
          <div className='flex flex-col justify-center px-7 py-10 lg:px-10 lg:py-12 gap-5'>
            ...
            {/* Bio */}
            <p
              className={`text-[14px] sm:text-[15px] text-white/55 leading-relaxed max-w-[480px] transition-all duration-700 ${
                visible
                  ? 'opacity-100 translate-x-0'
                  : 'opacity-0 translate-x-6'
              }`}
